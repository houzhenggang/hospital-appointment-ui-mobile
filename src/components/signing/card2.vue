<template>
  <div class="agreement-item">
    <div class="agreement-info" @click="handleClick">
      <div class="info-head">
        <div class="img">
      ...
      <div class="info-content">
        ...
        <div class="info-item">
          ...
          <div class="label" :class="formData.status === '1'? 'ok': 'no'">{{getStatus(formData.status)}}</div>
        </div>
        <div class="info-item">
    ...
    <div class="agreement-delete" @click="handleDelete" v-if="isDelete">
      <van-icon name="cross" />
    </div>
  </div>
</template>
